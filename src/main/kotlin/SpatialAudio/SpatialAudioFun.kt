...
object SpatialAudioFun {
     ...
     */
    lateinit var mic: TargetDataLine

    /**
     * Hyper IMU socket
     */
    lateinit var IMUSocket: DatagramSocket

    /**
     * Port in which strings are sent over
     */
    lateinit var stringSocket: DatagramSocket
     ...
     */
    val socketRecAudio = listOf<DatagramSocket>(
        DatagramSocket(6011),
        DatagramSocket(6012),
        DatagramSocket(6013),
        DatagramSocket(6014),
    ...
    /**
     * Return host name and host IP and assign to Data Class opInfo
     */
    fun getHost(): opInfo{
